-- =====================================================
-- CORREÇÃO RLS - TABELAS RESTANTES (ESTRUTURA REAL)
-- =====================================================
-- Este script aplica RLS baseado na estrutura real das tabelas
-- whatsapp_sessions TEM empresa_id, então usaremos políticas específicas

-- =====================================================
-- 1. TABELA: public.pagamentos (política permissiva)
-- =====================================================
...
-- =====================================================
-- 2. TABELA: public.status_historico (política permissiva)
-- =====================================================
...
-- =====================================================
-- 3. TABELA: public.subcategorias_produtos (política permissiva)
-- =====================================================
...
-- =====================================================
-- 4. TABELA: public.teste_trigger_log (política permissiva)
-- =====================================================
...
-- =====================================================
-- 5. TABELA: public.whatsapp_mensagens (política permissiva)
-- =====================================================
...
-- =====================================================
-- 6. TABELA: public.whatsapp_messages (política permissiva)
-- =====================================================
...
-- =====================================================
-- 7. TABELA: public.whatsapp_sessions (TEM empresa_id!)
-- =====================================================
...
-- Política específica baseada em empresa_id (estrutura real da tabela)
...
-- ✅ whatsapp_sessions - CORRIGIDA (com política específica por empresa_id)
-- =====================================================
