...
const resolveBannerTheme = (card: AlertCard, isDark: boolean): BannerTheme => {
  if (isDark) {
    ...
    const lightText = mixHexColors(accent, '#FFFFFF', 0.92);
    return {
      fundo: mixHexColors(accent, '#09090b', 0.55),
      border: mixHexColors(accent, '#FFFFFF', 0.55),
      shadow: hexToRgba(accent, 0.35),
      texto: '#ffffff',
      muted: lightText,
      chipBg: mixHexColors(accent, '#09090b', 0.35),
      iconBg: mixHexColors(accent, '#09090b', 0.35),
      iconRing: mixHexColors(accent, '#FFFFFF', 0.55),
      itemBg: '#18181b',
      itemHoverBg: '#27272a',
      itemBorder: mixHexColors(accent, '#FFFFFF', 0.45),
      itemMuted: mixHexColors(accent, '#FFFFFF', 0.75),
    };
  }
