      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {(osData.senha_aparelho || osData.senha_padrao) && (
          <div className="bg-white rounded-2xl border border-gray-100 p-8 mb-6">
            <div className="mb-8">
              <h3 className="text-2xl font-semibold text-gray-900 tracking-tight">Informações de Acesso</h3>
            ...
            <div className="space-y-8">
              {osData.senha_aparelho && (
                <div className="flex items-start gap-6">
                  ...
                  <div className="flex-1">
                    <h4 className="text-lg font-medium text-gray-900 mb-3">Senha do Aparelho</h4>
              ...
              {osData.senha_padrao && (
                <div className="flex items-start gap-6">
                  ...
                  <div className="flex-1">
                    <h4 className="text-lg font-medium text-gray-900 mb-4">Padrão de Desenho</h4>
                    <div className="flex items-center gap-6">
                      ...
                      <div className="text-sm text-gray-500">
                        ...
                        <code className="text-xs font-mono text-gray-600">
                          {JSON.parse(osData.senha_padrao).map((dot: number) => 
