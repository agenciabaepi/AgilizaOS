...
function PagarPlanoSkeleton() {
  return (
    <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8 animate-pulse" aria-busy="true">
      <div className="bg-white/90 rounded-2xl shadow-xl p-6 border border-gray-200 space-y-4">
        <div className="h-8 w-48 bg-gray-200 rounded" />
        <div className="h-4 w-full bg-gray-100 rounded" />
        <div className="rounded-xl border p-5 h-40 bg-gray-50" />
      </div>
      <div className="bg-white/95 rounded-2xl shadow-xl p-6 border border-gray-200 space-y-4">
        <div className="h-6 w-40 bg-gray-200 rounded" />
        <div className="rounded-xl border p-5 h-48 bg-gray-50" />
      </div>
    </div>
  );
}
      ...
      <header className="relative z-10 px-6 py-6 border-b border-white/10 bg-black/70 backdrop-blur">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-2 text-white/80 text-sm">
            <button type="button" className="hover:text-white" onClick={() => router.push('/')}>
              Início
            </button>
            <span className="opacity-60">/</span>
            <button type="button" className="hover:text-white" onClick={() => router.push('/planos')}>
              Planos
            </button>
            <span className="opacity-60">/</span>
            <span className="text-white">Pagamento</span>
          </div>
          <button type="button" className="text-white/80 hover:text-white text-sm" onClick={() => router.push('/planos')}>
            Voltar aos planos
          </button>
        </div>
      </header>
          ...
          <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div className="bg-white/90 rounded-2xl shadow-xl p-6 border border-gray-200">
              ...
              <div className="text-xs text-gray-500">
                Ao continuar, você concorda com os termos de uso e política de privacidade. O plano será ativado após a
            ...
            <div className="bg-white/95 rounded-2xl shadow-xl p-6 border border-gray-200">
              ...
              <div className="mt-4 text-[12px] text-gray-500">
                Pagamento processado com segurança pelo Mercado Pago. Após efetuar o pagamento, a ativação ocorre
                automaticamente em poucos instantes.
              </div>
