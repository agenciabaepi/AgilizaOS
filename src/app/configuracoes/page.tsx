...
const tabsConfig: TabConfig[] = [
  ...
  { name: 'WhatsApp', description: 'CRM WhatsApp — em desenvolvimento', group: 'integracoes', icon: MessageCircle, Component: WhatsAppPage, permissao: 'whatsapp', requerRecurso: null },
