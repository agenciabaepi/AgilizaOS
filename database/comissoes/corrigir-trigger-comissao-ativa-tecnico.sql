-- =====================================================
-- CORRIGIR TRIGGER PARA VERIFICAR comissao_ativa DO TÉCNICO
-- =====================================================
-- Este script atualiza a função registrar_comissao_automatica
-- para verificar se o técnico tem comissao_ativa = true antes de calcular

-- 1. ATUALIZAR FUNÇÃO PARA VERIFICAR comissao_ativa
-- =====================================================
...
BEGIN
    ...
    -- Se comissao_ativa = false, não calcular comissão
    ...
    BEGIN
        INSERT INTO comissoes_historico (
            ...
            tipo_ordem,
            observacoes,
            ativa -- Incluir campo ativa (será true por padrão para novas comissões)
        ) VALUES (
            NEW.tecnico_id,
            NEW.id,
            NEW.empresa_id,
...
'Registra comissão automaticamente quando uma OS é marcada como ENTREGUE ou FINALIZADA, MAS APENAS SE o técnico tiver comissao_ativa = true';
