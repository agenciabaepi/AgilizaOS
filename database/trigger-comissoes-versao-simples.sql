-- =====================================================
-- TRIGGER SIMPLIFICADO PARA REGISTRO DE COMISSÕES
-- =====================================================
-- Versão mais simples e robusta que sempre verifica se precisa registrar

-- 1. RECRIAR A FUNÇÃO COM LÓGICA SIMPLIFICADA
-- =====================================================
...
-- 2. RECRIAR O TRIGGER (SEM CONDIÇÃO WHEN COMPLEXA)
-- =====================================================
