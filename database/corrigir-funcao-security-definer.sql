-- =====================================================
-- CORRIGIR FUNÇÃO COM SECURITY DEFINER
-- =====================================================
-- Este script recria a função com SECURITY DEFINER para poder inserir mesmo com RLS
...
-- 2. VERIFICAR SE FOI CRIADA COM SECURITY DEFINER
-- =====================================================
SELECT 
    proname,
